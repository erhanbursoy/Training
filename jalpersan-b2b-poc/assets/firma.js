...
(function () {
  ...
  function panel() {
    ...
    /* Kartlarda etiket ve sayı yeter; açıklama satırı yok. Ne anlama geldikleri
       başlıklarında ve grafiklerde yazıyor, kartlar tıklanınca ilgili bölüme
       gidiyor. Sayılar: açık talep, işleme alınan talep, Logo'da miktarı
       değişmiş sipariş ve 7 günden uzun süredir kapanmayan sipariş. */
    kap.appendChild(h('div.grid.k4', {}, [
      kart('Talep edilen', acikTalep, 'talep', null, 'talepler', acikTalep > 0),
      kart('İşleme alınan', islemdeTalep, 'talep', null, 'siparisler'),
      kart("Logo'da değişen", degisen, 'sipariş', null, 'siparisler', degisen > 0),
      kart('Gecikmiş', gecikmis, 'sipariş', null, 'siparisler', gecikmis > 0)
    ]));
    return kap;
  }
